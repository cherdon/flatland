...
parser.add_argument('--max-rails-between-cities', type=int, default=2, help='Max number of tracks allowed between cities')
...
parser.add_argument('--predictor', type=str, default='ShortestPathPredictorForRailEnv', help='Predictor used for observation building')
parser.add_argument('--prediction-depth', type=int, default=150, help='Prediction depth of shortest path strategy')
...
# Model Training
parser.add_argument('--model-id', type=str, default="dqn-flatlands", help="Model Name")
parser.add_argument('--num-trials', type=int, default=1000, help="Number of trials to run")
parser.add_argument('--start-eps', type=float, default=1.0, help="Initial value of epsilon")
parser.add_argument('--end-eps', type=float, default=0.01, help="Lower limit of epsilon (can't decrease lower than this)")
parser.add_argument('--eps-decay', type=float, default=0.998, help="Decay factor to decrease epsilon in epsilon-greedy algo")
...
parser.add_argument('--update-every', type=int, default=10, help='Timesteps to update the target network')
parser.add_argument('--buffer-size', type=int, default=10000, help='Size of experience replay')
parser.add_argument('--batch-size', type=int, default=512, help='Batch size of experience replay')
